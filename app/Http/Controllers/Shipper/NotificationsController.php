...
class NotificationsController extends Controller {
    ...
    public function index() {
        ...
        $notifications = Notification::with(["userdetail"])->where(['notification_by' => $shipper_id])->orderBy('created_at', 'desc')->get();
        ...
        return view('shipper.notifications.index', ['notifications' => $notifications, 'notMaxID' => $notMaxID, 'recNotifications' => $recNotifications]);
    }
    ...
    public function create() {
        ...
        foreach ($user->shipperstores as $shipperstore) {
            $storeArr[$shipperstore->store_id] = $shipperstore->store_domain;
        }
        return view('shipper.notifications.create', ['mappedstores' => $storeArr]);
    }
    ...
    public function store(Request $request) {
        ...
        if ($notifySent) {
            return redirect('shipper/shippernotifications')->with('success', 'Notification send successfully!');
        } else {
