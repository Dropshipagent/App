...
class ExportOrderCsvLog extends Model {
     ...
     */
    protected $fillable = [
        'store_id', 'supplier_id', 'store_domain', 'csv_file_name',
    ];

    static function createNewLog($store_id, $supplier_id, $store_domain, $csv_file_name) {
        $orderexportcsv_log = new ExportOrderCsvLog;
        $orderexportcsv_log->store_id = $store_id;
        $orderexportcsv_log->supplier_id = $supplier_id;
