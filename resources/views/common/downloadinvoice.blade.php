    ...
    <table cellpadding="0" cellspacing="5" border="0" style="width:90% !important; margin: 25px auto 0;">
        <tr>
            <td colspan="2" class="text-center header_txtt">
                <h1><span class="color_ye">DROPSHIP</span>AGENT<span class="sub_heads"><i>INVOICES</i></span></h1>
            </td>
        </tr>
        <tr class="topheading">
        ...
        <tbody>
            ...
            ?>
                    <tr valign="center">
                        ...
                        <td class="amount" style="">{{ number_format(($invoice_items['item_price'][$oKey]*$invoice_items['item_qty'][$oKey]), 2) }}</td>
                    </tr>
                <?php
                }
            } else {
