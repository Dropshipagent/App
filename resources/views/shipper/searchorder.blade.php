    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
            <div class="box-body table-responsive no-padding">
                @if(!empty($order))
                {!! Form::open(array('url' => 'shipper/create_invoice','id' => 'invoiceForm','files'=>true,'method'=>'POST')) !!}
                {!! Form::hidden('shipper_id', $user->id) !!}
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    echo Form::number('variant_shipper_price[]', $invoicesubTotal, array('step' => 'any', 'min' => '0', 'max' => $invoicesubTotal, 'readonly', 'required' => 'required', 'class' => 'form-control'));
                                    ?>
                                </td>
                            </tr>
                            @endforeach
